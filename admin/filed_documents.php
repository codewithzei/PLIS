...
<head>
    ...
    <link rel="stylesheet" href="css/filed_documents.css">
            ...
            <div class="document-updates">
                <div class="title-and-search-container">
                    <div class="title-and-search-container title">
                        ...
                        <p>View and manage approved ordinances and resolutions</p>
                    </div>
                        ...
                        <div class="table">
                            <div class="data-cell">
                                <div class="table-row" role="row">
                                    <div class="table-cell" role="cell">PRN-2025-00001</div>
                                ...
                                <div class="table-row" role="row">
                                    <div class="table-cell" role="cell">PRN-2025-00002</div>
                                ...
                                <div class="table-row" role="row">
                                    <div class="table-cell" role="cell">PRN-2025-00003</div>
                                ...
                                <div class="table-row" role="row">
                                    <div class="table-cell" role="cell">PRN-2025-00004</div>
