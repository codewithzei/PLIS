        ...
        <aside class="sidebar">
            ...
            <div class="navigations">
                <nav class="sidebar-nav">
                    ...
                    <div class="nav-section">
                    <div class="nav-label active">SYSTEM ARCHIVE</div>
                    <ul>
            ...
            <div class="document-updates">
                <div class="title-and-search-container">
                    <div class="title-and-search-container title">
                        <h2>Archive</h2>
                        <p>View and manage archived documents</p>
                    </div>
                ...
                <div class="table-container">
                    <div class="table-header-fixed">
                        <div class="table-header">
                            ...
                            <div class="header-item" role="columnheader">Date Received</div>
                            <div class="header-item" role="columnheader">Date Archived</div>
                        ...
                        <div class="table">
                            <div class="data-cell">
                                <div class="table-row" role="row">
                                    ...
                                    <div class="table-cell" role="cell">2025-05-17	</div>
