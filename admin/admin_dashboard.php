    ...
    <div class="container">
        ...
        <main class="main-content">
            <div class="dashboard-one">
                ...
                <p>Route documents to recipients</p>

                <div class="route-button-container">
                    <a href="routed_documents.php" class="route-button">
                        <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                            <path d="M6.00053 12L3.26953 3.125C9.8024 5.025 15.9629 8.02646 21.4855 12C15.9632 15.9735 9.80306 18.9749 3.27053 20.875L6.00053 12ZM6.00053 12H13.5005" stroke="white" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"/>
                        </svg>
                    Initiate Routing
                    </a>
                </div>
            ...
            <div class="dashboard-two">
                ...
                <p>Summary and Insights</p>
            </div>
            <div class="dashboard-mid">
                <div class="top">
                    <h2>Hello Kitty!</h2>
                    <p>You have routed 12 documents this week.</p>
                    <div class="top-details">
                        <div class="top-content">
                            <div class="content-details">
                                <div class="icon-container processing">
                                    <svg width="26" height="27" viewBox="0 0 26 27" fill="none" xmlns="http://www.w3.org/2000/svg">
                                        <path d="M19.1214 9.0907C18.2054 7.90242 16.9623 7.00651 15.5443 6.51261C14.1263 6.0187 12.5949 5.94821 11.1374 6.30975C9.67987 6.67129 8.35952 7.44919 7.33783 8.54828C6.31615 9.64737 5.63745 11.02 5.38477 12.4982M19.5006 5.14233V9.46931H15.1673M6.8776 18.5019C7.79342 19.6906 9.03648 20.587 10.4546 21.0812C11.8727 21.5754 13.4044 21.646 14.8621 21.2844C16.3198 20.9228 17.6402 20.1447 18.6619 19.0453C19.6835 17.9459 20.362 16.5729 20.6143 15.0944M6.49952 22.4503V18.1233H10.8328" stroke="#0033A1" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"/>
                                    </svg>
                                </div>
                            ...
                            <div class="content-details">
                                <div class="icon-container on-hold">
                                    <svg width="26" height="27" viewBox="0 0 26 27" fill="none" xmlns="http://www.w3.org/2000/svg">
                                        <path d="M9.75065 7.20312H8.66732C8.38 7.20312 8.10445 7.31709 7.90129 7.51996C7.69812 7.72283 7.58398 7.99797 7.58398 8.28487V19.1023C7.58398 19.3892 7.69812 19.6644 7.90129 19.8672C8.10445 20.0701 8.38 20.1841 8.66732 20.1841H9.75065C10.038 20.1841 10.3135 20.0701 10.5167 19.8672C10.7198 19.6644 10.834 19.3892 10.834 19.1023V8.28487C10.834 7.99797 10.7198 7.72283 10.5167 7.51996C10.3135 7.31709 10.038 7.20312 9.75065 7.20312ZM17.334 7.20312H16.2507C15.9633 7.20312 15.6878 7.31709 15.4846 7.51996C15.2815 7.72283 15.1673 7.99797 15.1673 8.28487V19.1023C15.1673 19.3892 15.2815 19.6644 15.4846 19.8672C15.6878 20.0701 15.9633 20.1841 16.2507 20.1841H17.334C17.6213 20.1841 17.8969 20.0701 18.1 19.8672C18.3032 19.6644 18.4173 19.3892 18.4173 19.1023V8.28487C18.4173 7.99797 18.3032 7.72283 18.1 7.51996C17.8969 7.31709 17.6213 7.20312 17.334 7.20312Z" stroke="#D09C00" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"/>
                                    </svg>
                                </div>
                                <div class="text-container">
                                    <h2>2 documents </h2>
                            ...
                            <div class="content-details">
                                <div class="icon-container approved">
                                    <svg width="26" height="27" viewBox="0 0 26 27" fill="none" xmlns="http://www.w3.org/2000/svg">
                                        <path d="M9.20833 13.0501L11.9167 15.7544L16.25 11.4274M22.75 13.5909C22.75 14.8694 22.4978 16.1354 22.0078 17.3166C21.5178 18.4978 20.7997 19.5711 19.8943 20.4751C18.9889 21.3792 17.9141 22.0963 16.7312 22.5855C15.5482 23.0748 14.2804 23.3266 13 23.3266C11.7196 23.3266 10.4518 23.0748 9.26884 22.5855C8.08591 22.0963 7.01108 21.3792 6.10571 20.4751C5.20034 19.5711 4.48216 18.4978 3.99217 17.3166C3.50219 16.1354 3.25 14.8694 3.25 13.5909C3.25 11.0089 4.27723 8.53254 6.10571 6.70675C7.93419 4.88095 10.4141 3.85522 13 3.85522C15.5859 3.85522 18.0658 4.88095 19.8943 6.70675C21.7228 8.53254 22.75 11.0089 22.75 13.5909Z" stroke="#1F8824" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"/>
                                    </svg>
                                </div>
                                <div class="text-container">
                                    <h2>3 documents </h2>
                        ...
                        <img src="images/Illustration Woman.png" alt="User" class="user-illustration">
                    </div>
                </div>
                <div class="bottom">
                    <h2>Total Documents</h2>
                    <p>Monthly document reports</p>
                </div>
            </div>
            <div class="dashboard-three">
                <h2>Document Outcome Analysis</h2>
                <p>Insights into document patterns</p>
            </div>
            <div class="dashboard-four">
                <h2>Upload Documents</h2>
                <p>You have <span>12</span> documents to be filed</p>
            ...
            <div class="total-documents-container">
                <h2>Total Documents</h2>
